...
enum class ImageSource {
  ...
  val websiteUrl
    get() = when (this) {
      ...
      THIS_NIGHT_SKY_DOES_NOT_EXIST -> """
                https://www.arthurfindelair.com/thisnightskydoesnotexist/
      """.trimIndent()
    }
  ...
  fun getImageUrl(imageId: String) = when (this) {
    ...
    THIS_NIGHT_SKY_DOES_NOT_EXIST -> """
            https://firebasestorage.googleapis.com/v0/b/thisnightskydoesnotexist.appspot.com/o/images%2Fseed$imageId.jpg?alt=media
    """.trimIndent()
  }
