...
import com.isao.yfoo3.data.LikedImageCachedQueries
...
class LikedImageDaoSqlDelight(
    private val queries: LikedImageCachedQueries,
) : LikedImageDao {

    override fun getLikedImages(): Flow<List<LikedImageCached>> {
        return queries.selectAllLikedImages(::mapToData)
            .asFlow()
    ...
    override fun getLikedImages(
        ...
        return queries.selectLikedImages(
            sortAscending,
            limit.toLong(),
            offset.toLong(),
            ::mapToData
