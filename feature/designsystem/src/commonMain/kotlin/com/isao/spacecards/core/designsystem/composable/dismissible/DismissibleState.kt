package com.isao.spacecards.core.designsystem.composable.dismissible
...
import com.isao.spacecards.feature.common.util.toRadians
...
class DismissibleState(
  ...
  private fun getEndX(
    ...
    val maxRotationsRadians = toRadians(maxRotationZ.toDouble())
    val ninetyDegreesRadians = toRadians(90.0)
