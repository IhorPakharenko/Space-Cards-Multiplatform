...
data class DismissThresholds(
  ...
  val minHorizontalProgressThreshold: Float = 0.6f,
  val minVerticalProgressThreshold: Float = 0.6f,
)
...
private data class DismissibleElement(
  ...
  override fun update(node: DismissibleNode) {
    ...
    // Due to FeedScreen shenanigans (namely wrapping rememberDismissibleState in key {...}),
    // we might get an instance of state without real density. So we update density manually here.
